...
var grammar = {
    ...
    {"name": "statement", "symbols": ["_", {"literal":"break"}, "_", (tokens.has("semicolon") ? {type: "semicolon"} : semicolon), "NL"], "postprocess": data => normalizeData(data)},
    ...
    {"name": "vardecl$ebnf$1$subexpression$1", "symbols": [(tokens.has("lbracket") ? {type: "lbracket"} : lbracket), (tokens.has("int") ? {type: "int"} : int), (tokens.has("rbracket") ? {type: "rbracket"} : rbracket)]},
    ...
    {"name": "atribstat$ebnf$1$subexpression$1$subexpression$1", "symbols": ["allocexpression"]},
    ...
    {"name": "atribstat", "symbols": ["lvalue", "atribstat$ebnf$1"], "postprocess": data => normalizeData(normalizeData(normalizeData(data)))},
    ...
    {"name": "forstat", "symbols": [{"literal":"for"}, "_", (tokens.has("lparan") ? {type: "lparan"} : lparan), "_", "vardecl", "_", (tokens.has("semicolon") ? {type: "semicolon"} : semicolon), "_", "expression", "_", (tokens.has("semicolon") ? {type: "semicolon"} : semicolon), "_", "atribstat", "_", (tokens.has("rparan") ? {type: "rparan"} : rparan), "_", "statement"], "postprocess": data => normalizeData(data)},
    ...
    {"name": "allocexpression", "symbols": [{"literal":"new"}, "_", "type_keyword", "allocexpression$ebnf$1"], "postprocess": data => normalizeData(normalizeData(normalizeData(data)))},
    ...
    {"name": "factor", "symbols": [(tokens.has("float") ? {type: "float"} : float)], "postprocess": id},
    {"name": "factor", "symbols": [(tokens.has("int") ? {type: "int"} : int)], "postprocess": id},
    ...
    {"name": "lvalue$ebnf$1$subexpression$1", "symbols": [(tokens.has("lbracket") ? {type: "lbracket"} : lbracket), (tokens.has("int") ? {type: "int"} : int), (tokens.has("rbracket") ? {type: "rbracket"} : rbracket), "_"]},
